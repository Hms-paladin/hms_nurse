        ...
        <Paper className="paper">
          <div className="tableWrapper">
            ...
            >
              ...
              <TableBody>
              {
                  this.state.rows.length === 0 && <TableCell className={"noFoundIconCenter"} colSpan={12}>
                    <img src={NotfoundIcon} /><div>No Data Found</div></TableCell>
                }
                {stableSort(
                  this.state.rows,
                      ...
                      >
                        ...
                        <TableCell className={`${this.props.tableicon_align}`}>
                          ...
                          {this.props.LocationOnIcon==="close"? null:
                             <LocationOnIcon className="tablelocation_icon" onClick={() => this.props.modelopen("location",row.id)}/>}
                          {this.props.HistoryIcon==="close"? null:
                             <HistoryIcon className="tablehistory_icon" onClick={() => this.props.modelopen("history",row.id)}/>}
